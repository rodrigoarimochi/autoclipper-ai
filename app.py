...
st.markdown("Transforme podcasts e vídeos longos em cortes virais verticais (9:16) automaticamente com IA.")
...
with st.sidebar:
    ...
    st.info("Dica: Use vídeos de 2 a 15 minutos para testar mais rápido na hospedagem gratuita.")
...
def transcribe_audio(video_path):
    # Usa CPU int8 para rodar leve na nuvem gratuita
